...
class CreateSchedulers(unittest.TestCase):
    ...
    def test_case01(self):
        ...
        flow_table = xlrd.open_workbook("./api_test_cases/flow_dataset_info.xls")  # 定时任务调用
        # flow_table = xlrd.open_workbook("flow_dataset_info.xls") # 单文件调用
    ...
    def test_case02(self):
        ...
        flow_table = xlrd.open_workbook("./api_test_cases/flow_dataset_info.xls")  # 定时任务使用
